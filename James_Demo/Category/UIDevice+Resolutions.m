...
//  爱豆
//
//  Created by idol_ios on 15/1/31.
//  Copyright (c) 2015年 idol_ios. All rights reserved.
//
...
+ (BOOL)is_Ipad2
{
    if ([self currentResolution] == UIDevice_iPadStandardRes) {
        return YES;
    }
    return NO;
}
...
+ (BOOL)is_Ipad_Retina
{
    if ([self currentResolution] == UIDevice_iPadHiRes) {
        return YES;
    }
    return NO;
}
